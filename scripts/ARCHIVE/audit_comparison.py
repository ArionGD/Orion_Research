...
def run_india_comparative_audit():
    print("=== ACE: Arion Crash Engine - INDIA (NIFTY) COMPARATIVE AUDIT ===")
    ...
    print("\nScanning INDIA Period A: 2015 - 2025...")
    past = scan_period(2015, 2025)
    
    print("Scanning INDIA Period B: 2026 - 2035...")
    future = scan_period(2026, 2035)
    
    print("\n" + "="*60)
    print("ACE: INDIA (NIFTY) MULTI-TIER AUDIT (SIDE-BY-SIDE)")
    print("="*60)
    print(f"TIER             | 2015-2025 (PAST) | 2026-2035 (FUTURE)")
    print(f"----------------------------------------------------------")
